...
bool BaterryCharge::init()
{
	...
	Util::addBackground("waittocharge.png", this);
	//Sleep(1000);
...
void BaterryCharge::update(float dt)
{
	CCLog("dt = %g", dt);
	int i = 0;
	i++;
...
void BaterryCharge::mySchedule(float dt)
{
