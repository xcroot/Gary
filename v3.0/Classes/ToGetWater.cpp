...
bool ToGetWater::init()
{
	...
	Util::addBackground("waittobatai.png", this);
	//Sleep(1000);
...
void ToGetWater::update(float dt)
{
	CCLog("dt = %g", dt);
	int i = 0;
	i++;
...
void ToGetWater::mySchedule(float dt)
{
